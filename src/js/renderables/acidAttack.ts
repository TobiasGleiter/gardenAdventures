...
class AcidAttack extends me.Entity {
  ...
  constructor(x: number, y: number, settings: MSettingsBullet, pitch: number) {
    ...
    this.renderable.addAnimation('acid_Attack', [180, 181, 182, 183, 184]);
    this.renderable.setCurrentAnimation('acid_Attack');
