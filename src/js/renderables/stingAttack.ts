...
class StingAttack extends me.Entity {
  ...
  constructor(x: number, y: number, settings: MSettingsBullet, pitch: number) {
    ...
    this.renderable.addAnimation('sting_Attack', [160, 161, 162, 163]);
    this.renderable.setCurrentAnimation('sting_Attack');
